...
public interface SchedulingClient {
    ...
    /**
     * Helper method to convert LocalDateTime to ISO string format and extract Boolean from ApiResult.
     */
    default Boolean isInstructorAvailable(Long instructorId, LocalDateTime startTime, LocalDateTime endTime) {
        DateTimeFormatter formatter = DateTimeFormatter.ISO_LOCAL_DATE_TIME;
        ApiResult<Boolean> result = isInstructorAvailable(instructorId, startTime.format(formatter), endTime.format(formatter));

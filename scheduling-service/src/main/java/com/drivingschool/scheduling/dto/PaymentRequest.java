...
@Schema(description = "Request DTO for creating a payment from scheduling service")
public record PaymentRequest(
    ...
    @Schema(description = "Additional notes about the payment", example = "Payment for lesson")
    String notes
) {
}

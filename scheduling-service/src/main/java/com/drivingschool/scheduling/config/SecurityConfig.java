    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/lessons/**").hasAnyRole("INSTRUCTOR", "ADMIN", "SERVICE")
                        .requestMatchers(HttpMethod.PUT, "/api/lessons/**").hasAnyRole("INSTRUCTOR", "ADMIN", "SERVICE")
                        .requestMatchers(HttpMethod.PATCH, "/api/lessons/**").hasAnyRole("INSTRUCTOR", "ADMIN", "SERVICE")
                        .requestMatchers(HttpMethod.DELETE, "/api/lessons/**").hasAnyRole("ADMIN", "SERVICE")

    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http, JwtService jwtService) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(HttpMethod.POST, "/api/students/me/documents").hasAnyRole("STUDENT", "ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/api/students/me/documents/**").hasAnyRole("STUDENT", "ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/api/students/me/documents/**").hasAnyRole("STUDENT", "ADMIN")
                        .pathMatchers(HttpMethod.GET, "/api/students/me/documents").hasAnyRole("STUDENT", "ADMIN")
